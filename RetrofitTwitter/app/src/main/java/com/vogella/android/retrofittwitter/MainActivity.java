...
public class MainActivity extends AppCompatActivity {
    ...
    private String credentials = Credentials.basic("fl1WBCjo91SV7eByIKKE941YA", "fNikTHriYTAzeJI8x51clWCHJYWalwlopJ6fFQ6nEV6rLwpRF7");

    Button requestTokenButton,requestUserDetailsButton;
    EditText usernameEditText;
    TextView usernameTextView,nameTextView, locationTextView,urlTextView;
        ...
        OkHttpClient okHttpClient = new OkHttpClient.Builder().addInterceptor(new Interceptor() {
            ...
            public okhttp3.Response intercept(Chain chain) throws IOException {
                ...
                Request.Builder builder = originalRequest.newBuilder()
                        .header("Authorization", token != null ? token.getAuthorization() : credentials);
        ...
        public void onResponse(Call<OAuthToken> call, retrofit2.Response<OAuthToken> response) {
            if(response.isSuccessful()){
                ...
                Toast.makeText(MainActivity.this,
                        ...
                        Toast.LENGTH_LONG).show();
                Log.d("RequestTokenCallback", "Code: "+response.code()+
        ...
        public void onResponse(Call<UserDetails> call, retrofit2.Response<UserDetails> response) {
            if(response.isSuccessful()){
                ...
                nameTextView.setText(userDetails.getName()
                        == null ? "no value":userDetails.getLocation());

                locationTextView.setText(userDetails.getLocation()
                        == null ? "no value": userDetails.getLocation());
                urlTextView.setText(userDetails.getUrl() == null ? "no value":
                        userDetails.getUrl());
                descriptionTextView.setText(userDetails.getDescription().isEmpty()?
                        "no value": userDetails.getDescription());
            }else{
                Toast.makeText(MainActivity.this,
